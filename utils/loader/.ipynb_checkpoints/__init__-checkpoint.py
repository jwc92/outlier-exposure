...
from utils.loader.modified_dataset import Gray2RGB, MNIST_OOD, FashionMNIST_OOD, \
...
from utils.augmentations.augmentations import ToGray, Invert, Fragment
...
#     data_path = data_dict["path"][split_type] if split_type in data_dict["path"] else data_dict["path"]
    data_path = '/data/private/OOD+RL/ood-research/src/datasets'
